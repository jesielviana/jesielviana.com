...
- [VS Code](https://code.visualstudio.com/) - open-source, totalmente gratuito, um dos editores de código mais utilizado atualmente, com suporte a praticamente todas as linguagens de programação (**meu favorito**).
