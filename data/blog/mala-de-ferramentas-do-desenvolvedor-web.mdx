...
- [Adobe XD](https://www.adobe.com/br/products/xd/features.html) - tem basicamente as mesmas características do Figma
...
Nesse contexto, recomendo a utilização das ferramentas de integração e entrega contínua dos próprios serviços Git, tais como o [GitHub Actions](https://github.com/features/actions) do Github e o [GitLab CI/CD](https://docs.gitlab.com/ee/ci/) do Gitlab.
